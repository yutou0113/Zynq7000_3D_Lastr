...
//	HoriOffset.V0BlankHoriStart=0;
//	HoriOffset.V0BlankHoriEnd=0;
//	HoriOffset.V1BlankHoriStart=0;
//	HoriOffset.V1BlankHoriEnd=0;
//	HoriOffset.V0SyncHoriStart=1;
//	HoriOffset.V0SyncHoriEnd=80;
//	HoriOffset.V1SyncHoriStart=720;
//	HoriOffset.V1SyncHoriEnd=800;
//
//	XVtc_SetGeneratorHoriOffset(&(dispPtr->vtc),&HoriOffset);
...
//	}
//
//	Status = XAxiVdma_DmaConfig(dispPtr->vdma, XAXIVDMA_WRITE, &(dispPtr->vdmaConfig));
//	if (Status != XST_SUCCESS)
//	{
//		xdbg_printf(XDBG_DEBUG_GENERAL, "Read channel config failed %d\r\n", Status);
//		return XST_FAILURE;
...
//	}
//
//	Status = XAxiVdma_DmaSetBufferAddr(dispPtr->vdma, XAXIVDMA_WRITE, dispPtr->vdmaConfig.FrameStoreStartAddr);
//	if (Status != XST_SUCCESS)
//	{
//		xdbg_printf(XDBG_DEBUG_GENERAL, "Read channel set buffer address failed %d\r\n", Status);
//		return XST_FAILURE;
...
//	}
//
//	Status = XAxiVdma_DmaStart(dispPtr->vdma, XAXIVDMA_WRITE);
//	if (Status != XST_SUCCESS)
//	{
//		xdbg_printf(XDBG_DEBUG_GENERAL, "Start read transfer failed %d\r\n", Status);
//		return XST_FAILURE;
...
//	}
//
//	Status = XAxiVdma_StartParking(dispPtr->vdma, dispPtr->curFrame, XAXIVDMA_WRITE);
//	if (Status != XST_SUCCESS)
//	{
//		xdbg_printf(XDBG_DEBUG_GENERAL, "Unable to park the channel %d\r\n", Status);
//		return XST_FAILURE;
...
//		return XST_FAILURE;
//	}
//	Status = XAxisScr_CfgInitialize(&AxisSwitch, Config,Config->BaseAddress);
//	if (Status != XST_SUCCESS) {
