...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = OV_Sensor_cc
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = OV_Sensor_cc_0
END
...
BEGIN LIBRARY
 ...
 PARAMETER memp_n_tcp_seg = 2560
 PARAMETER pbuf_pool_bufsize = 17000
 PARAMETER pbuf_pool_size = 512
 PARAMETER tcp_snd_buf = 81920
END
